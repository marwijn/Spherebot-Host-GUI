...
QT_MOC_LITERAL(6, 68, 10)
    ...
    "txThread\0progressChanged\0\0layerTransmitted\0"
    "fileTransmitted\0sendNext\0resetState\0"
};
...
void txThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->layerTransmitted(); break;
        case 2: _t->fileTransmitted(); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&txThread::layerTransmitted)) {
                *result = 1;
            }
        }
        {
...
// SIGNAL 1
void txThread::layerTransmitted()
{
